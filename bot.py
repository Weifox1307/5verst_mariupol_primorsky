...
SPAM_KEYWORDS = [
    ...
    "подпишись", "казино", "crypto", "invest", "М Р Э О",  "Предлагаю помощь по части М Р Э О за вознаграждение, подготовка документов (сертификат из автошколы, медицинское заключение, заявления и прочая документация). 
Так же помогу переоформить/поставить на учёт т.с., без очереди и прочего геморроя. 
Таможенные услуги, восстановление после лишения, замена водительского для иностранцев и прочий спектр услуг. 
Важно!!! НИКАКОЙ ЛИПЫ ИЛИ ФАЛЬШИВОГО ДОКУМЕНТА, ВСЕ ОФИЦИАЛЬНО! 
Для консультации пишите или звоните!", "trading"
]
